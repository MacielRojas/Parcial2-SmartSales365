from app_api.application.usecases.Categoria_usecase import CategoriaUseCase
from app_api.infraestructure.repositories.djangoCategoria_repository import DjangoCategoriaRepository
...
class CategoriaView(APIView):
    ...
    def get(self, request, id=None):
        obj_crud = CategoriaUseCase(repository=DjangoCategoriaRepository())
        try:
